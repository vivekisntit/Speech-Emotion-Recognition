...
X_PATH = "data/processed/features_bilstm_adv.npy"
Y_PATH = "data/processed/labels_bilstm_adv.npy"

def main():
    X = np.load(X_PATH)
    Y = np.load(Y_PATH)

    # class weight only for 6 classes
    classes = np.unique(Y)
    ...
    model.save("outputs/models/bilstm_adv/model_bilstm_adv.keras")
